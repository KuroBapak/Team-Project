    ...
    public function process(Request $request)
    {
        ...
        $request->validate([
            ...
            'mode' => [
                ...
                'in:removebg,superres,autocolor,lowlight_enhance,grayscale,brightness_contrast,rotate,resize,flip,gamma,threshold,histogram_equalization,sharpen,sobel_edge,morphology,hue_saturation,contrast_stretching,gaussian_blur,mean_blur,median_blur,laplacian_edge,prewitt_edge,low_pass_filter,high_pass_filter'
            ],
        ]);
        ...
        $toolType = session('tool_type', 'basic'); // Note: This assumes all these modes are 'advanced' in your logic
