    ...
    <!-- navbar start -->
        ...
        <!-- Content -->
                ...
                <div class="col-lg-6 rounded-3 border" style="background-color: white;">
                    <h3 class="mt-4 mb-3 ms-3 fw-bold">Data Jurusan</h3>
                    <div class="container">
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3 border rounded-2">
                                    <label for="exampleInputEmail1" class="form-label ps-2">Nama Jurusan</label>
                                    <input type="email" class="form-control border-0" id="exampleInputEmail1" placeholder="Nama Jurusan" aria-describedby="emailHelp">
                                  </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3 border rounded-2">
                                    <label for="exampleInputEmail1" class="form-label ps-2">Singkatan Jurusan (Max 4)</label>
                                    <input type="email" class="form-control border-0" id="exampleInputEmail1" placeholder="Contoh : RPL" aria-describedby="emailHelp">
                                  </div>
                            </div>
                        </div>
                          <div class="text-end mb-3">
                              <button type="button" class="btn btn-outline-primary mb-3">Kembali</button>
                              <button type="button" class="btn btn-danger mb-3">Ubah</button>
                          </div>
                    </div>
                </div>
                <div class="col-3">
