    ...
    <!-- navbar start -->
        ...
        <!-- Content -->
                ...
                <div class="col-lg-6 rounded-3 border" style="background-color: white;">
                    <h3 class="mt-4 mb-3 ms-3 fw-bold">Data Guru BK</h3>
                    <div class="container">
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3 border rounded-2">
                                    <label for="exampleInputEmail1" class="form-label ps-2">NIP</label>
                                    <input type="email" class="form-control border-0" id="exampleInputEmail1" placeholder="Kelas Siswa" aria-describedby="emailHelp">
                                  </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3 border rounded-2">
                                    <label for="exampleInputEmail1" class="form-label ps-2">Nama</label>
                                    <input type="email" class="form-control border-0" id="exampleInputEmail1" placeholder="Kelas Siswa" aria-describedby="emailHelp">
                                  </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3 border rounded-2">
                                    <label for="exampleInputEmail1" class="form-label ps-2">Password Baru</label>
                                    <input type="email" class="form-control border-0" id="exampleInputEmail1" placeholder="Kelas Siswa" aria-describedby="emailHelp">
                                  </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3 border rounded-2">
                                    <label for="exampleInputEmail1" class="form-label ps-2">Username</label>
                                    <input type="email" class="form-control border-0" id="exampleInputEmail1" placeholder="Kelas Siswa" aria-describedby="emailHelp">
                                  </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3 border rounded-2">
                                    <label for="exampleInputEmail1" class="form-label ps-2">Konfirmasi Password</label>
                                    <input type="email" class="form-control border-0" id="exampleInputEmail1" placeholder="Kelas Siswa" aria-describedby="emailHelp">
                                  </div>
                            </div>
                        </div>
