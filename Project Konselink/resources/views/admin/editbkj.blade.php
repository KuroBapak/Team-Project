                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3 border rounded-2">
                                    <label for="exampleInputEmail1" class="form-label ps-2">Nama Guru BK</label>
                                    <select class="form-select border-0" aria-label="Default select example">
                                        <option selected>Pilih Guru BK</option>
                            ...
                            <div class="col-6">
                                <div class="mb-3 border rounded-2">
                                    <label for="exampleInputEmail1" class="form-label ps-2">Jurusan BK</label>
                                    <select class="form-select border-0" aria-label="Default select example">
