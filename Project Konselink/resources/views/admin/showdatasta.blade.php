    ...
    <!-- navbar start -->
        ...
        <!-- Content -->
                ...
                <div class="col-lg-6 rounded-3 border" style="background-color: white;">
                    <h3 class="mt-4 mb-3 ms-3 fw-bold">Data Jurusan BK</h3>
                    <div class="container">
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3 border rounded-2">
                                    <label for="exampleInputEmail1" class="form-label ps-2">NIS</label>
                                    <input type="email" class="form-control border-0" id="exampleInputEmail1" placeholder="Isi Nis" aria-describedby="emailHelp">
                                  </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3 border rounded-2">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3 border rounded-2">
                                    ...
                                    <input type="email" class="form-control border-0" id="exampleInputEmail1" placeholder="Isi NISN" aria-describedby="emailHelp">
                                  </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3 border rounded-2">
                                    <label for="exampleInputEmail1" class="form-label ps-2">Tempat, Tanggal Lahir</label>
                                    <input type="email" class="form-control border-0" id="exampleInputEmail1" placeholder="Isi Tempat, Tanggal Lahir" aria-describedby="emailHelp">
                                  </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="mb-3 border rounded-2">
                                    ...
                                    <input type="email" class="form-control border-0" id="exampleInputEmail1" placeholder="Agama Siswa" aria-describedby="emailHelp">
                                  </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="mb-3 border rounded-2">
                                    <label for="exampleInputEmail1" class="form-label ps-2">Alamat</label>
                                    <input type="email" class="form-control border-0" id="exampleInputEmail1" placeholder="Alamat Siswa" aria-describedby="emailHelp">
                                  </div>
                            </div>
                        </div>
