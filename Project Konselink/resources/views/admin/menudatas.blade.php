                    ...
                    <div class="container mt-4 mb-4">
                        <div class="container-fluid rounded-2 border border-dark pb-2 pt-2" style="background-color: white;">
                            <table class="table text-dark border-dark">
                                <tbody>
                                  <tr>
                                    <td><a class="text-decoration-none text-dark" href="url">Rekayasa Perangkat Lunak (RPL)</a></td>
                                    </a>
                                  </tr>
                                </tbody>
                                <tbody>
                                    <tr>
                                      <td><a class="text-decoration-none text-dark" href="url">Tehnik Komputer Dan Jaringan (TKJ)</a></td>
                                    </tr>
                                  </tbody>
                                  <tbody>
                                    <tr>
                                      <td><a class="text-decoration-none text-dark" href="url">Tehnik Mesin (TM)</a></td>
                                      </a>
                                    </tr>
                                  </tbody>
                                  <tbody>
                                      <tr>
                                        <td><a class="text-decoration-none text-dark" href="url">Tehnik Pengelasan (TPL)</a></td>
                                      </tr>
                                    </tbody>
                                    <tbody>
                                        <tr>
                                          <td><a class="text-decoration-none text-dark" href="url">Tehnik Instalasi Tenaga Listrik(TITL)</a></td>
                                          </a>
                                        </tr>
                                      </tbody>
                                      <tbody>
                                          <tr>
                                            <td><a class="text-decoration-none text-dark" href="url">Tehnik Elektronik (TEI)</a></td>
                                          </tr>
                                        </tbody>
                                        <tbody>
                                            <tr>
                                              <td><a class="text-decoration-none text-dark" href="url">Tehnik Fabrikasi Logam Manufacturing (TFLM)</a></td>
                                            </tr>
                                          </tbody>
                                          <tbody>
                                            <tr>
                                              <td><a class="text-decoration-none text-dark" href="url">Tehnik Sepeda Motor (TSM)</a></td>
                                              </a>
                                            </tr>
                                          </tbody>
                                          <tbody>
                                              <tr>
                                                <td><a class="text-decoration-none text-dark" href="url">Tehnik Kendaraan Ringan Otomotif (TKRO)</a></td>
                                              </tr>
                                            </tbody>
                                            <tbody>
                                                <tr>
                                                  <td><a class="text-decoration-none text-dark" href="url">Design Gambar Mesin (DGM)</a></td>
                                                  </a>
                                                </tr>
                                              </tbody>
                                              <tbody>
                                                  <tr>
                                                    <td><a class="text-decoration-none text-dark" href="url">Design Pembangunan Informasi Bangunan (DPIB)</a></td>
                                                  </tr>
                                                </tbody>
                              </table>
                        </div>
