    ...
    <!-- navbar start -->
        ...
        <!-- Content -->
                ...
                <div class="col-lg-6 rounded-3 border" style="background-color: white;">
                    <h3 class="mt-4 mb-3 ms-3 fw-bold">Bimbingan Klasikal</h3>
                    <div class="container">
                        <div class="row">
                            <div class="col-6">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="exampleFormControlTextarea1" placeholder="Materi Bimbingan Klasikal" rows="3"></textarea>
                          </div>
